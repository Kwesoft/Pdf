...
namespace Kwesoft.Pdf.UnitTests
{
	...
	class PdfDoubleTests
	{
		...
		[TestCase((float)1.5, "1.5")]
		[TestCase((double)1.123123123123, "1.123123123123")]
		public void ConvertToString(dynamic input, string expected)
		{
			var result = ((PdfDouble)input).ToString();
